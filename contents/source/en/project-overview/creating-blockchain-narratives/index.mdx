...
In the Source Agents universe, Oracles are a profession and a social class. They are the only participants whose testimony the Synth-Net accepts as ground truth about the physical world. This gives them enormous structural power — and makes them targets for pressure, coercion, and replacement.
...
STRIDE is a threat modeling framework that categorizes attack types: Spoofing, Tampering, Repudiation, Information Disclosure, Denial of Service, and Elevation of Privilege. In Source Agent: FIGHT, these become the STRIDE gang — a crew of antagonists where each member embodies a specific attack vector as both a fighting style and a philosophy.
