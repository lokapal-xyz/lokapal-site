...
Users can optionally hash their content locally using strict normalization rules:
...
Tests are run via Foundry and achieve high coverage, ensuring reliability across mainnet deployment.
...
3. **Verify authenticity** of text claims
