...
description: "DAOs are inherently interactive, since they arise as a response to governance needs in the Web3 space. But these interactions can dramatically shift a DAO's behavior and objectives."
date: 19-04-2025
authors:
...
<Image
  src="/images/boundedness-spectrum.png"
  alt=""
  width={3840}
  height={3840}
  className="mx-auto"
