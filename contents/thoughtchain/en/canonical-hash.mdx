...
The Canonical Hash is generated using a **cryptographic hash function**, specifically **SHA-256**, which is the native, gas-efficient standard on the Ethereum Virtual Machine (EVM).
