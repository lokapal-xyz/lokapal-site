...
In the age of Web2, a digital text has no inherent integrity. The original file can be copied, altered, and re-uploaded endlessly without detection. The reader must always trust the platform (Amazon, a publisher's website) to provide the authentic text.
