...
import { EachRoute, ROUTES, getRoutesForSection } from "./routes-config";
...
export function advanceSearch(query: string, dict: Dictionary, section?: "source" | "fmao" | "conciliatorics") {
